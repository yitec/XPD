...
function crea_usuario($parametros,$hoy){
	...
	$result=mysql_query("insert into tbl_usuarios(nombre,apellidos,cedula,usuario,clave,fecha_vencimiento,estado)values('".utf8_encode($v_datos[0])."','".utf8_encode($v_datos[1])."','".$v_datos[2]."','".$v_datos[3]."','".$v_datos[4]."','".$v_datos[5]."','"."1"."')");
